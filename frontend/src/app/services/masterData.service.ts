...
export const masterDataService = {
  ...
  async createUser(input:{firstName:string;lastName:string;email:string;username:string;password:string;role:"OWNER"|"BRANCH_MANAGER";branchId:string|null;status:RecordStatus}) { return (await api.post<ApiSuccess<{user:ManagedUser}>>("/users",input)).data.data.user; },
