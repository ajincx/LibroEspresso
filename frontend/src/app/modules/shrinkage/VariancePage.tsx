...
export function VariancePage() {
  ...
  return <div className="p-6 space-y-5">
    <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4"><div><h1 className="text-2xl font-bold">Variance &amp; Discrepancies</h1><p className="text-sm mt-1" style={{ color: "var(--app-text-muted)" }}>System-calculated comparison of expected inventory and submitted physical counts. Values cannot be manually entered here.</p></div><div className="flex gap-2 flex-wrap">
