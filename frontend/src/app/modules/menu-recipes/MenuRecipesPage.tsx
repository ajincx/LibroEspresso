...
export const marginTextClass = (margin:number) => margin > 0 ? "text-[var(--app-success)]" : margin < 0 ? "text-[var(--app-danger)]" : "text-[var(--app-text-muted)]";
        ...
        {products.map((product) => {
          ...
          return (
            <TR key={product.id} onClick={() => onView(product)} className="cursor-pointer" style={{ opacity: busy ? 0.65 : 1 }}>
              ...
              <TD right bold className={marginTextClass(product.marginRate)}>
