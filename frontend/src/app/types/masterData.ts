...
export interface ManagedUser { id:string; branchId:string|null; firstName:string; lastName:string; email:string; username:string; role:UserRole; status:RecordStatus; branchCode:string|null; branchName:string|null; lastLoginAt:string|null; createdAt:string; updatedAt:string }
